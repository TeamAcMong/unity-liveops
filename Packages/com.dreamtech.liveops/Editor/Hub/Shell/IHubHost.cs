...
namespace DreamTech.LiveOps.Editor
{
    ...
    /// <see cref="Services"/>; chữ ký này đóng băng khi cổng W3 xanh (PD-35).
    /// </summary>
    internal interface IHubHost
    {
        ...
        /// <summary>Composition root của cửa sổ (G-SESSION): phiên lịch, port, bus. Màn đọc phiên qua đây, không tự dựng adapter.</summary>
